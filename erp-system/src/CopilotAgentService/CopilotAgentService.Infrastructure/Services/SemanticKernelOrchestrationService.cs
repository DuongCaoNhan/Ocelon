...
namespace CopilotAgentService.Infrastructure.Services
{
    /// <summary>
    ...
    public class SemanticKernelOrchestrationService : IAgentOrchestrationService, ISemanticKernelService
    {
        ...
        public async Task<string> GenerateResponseAsync(string context, string userInput, CancellationToken cancellationToken = default)
        {
            try
            {
