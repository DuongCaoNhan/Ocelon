...
using CopilotAgentService.Infrastructure.Data;
using CopilotAgentService.Infrastructure.Repositories;
using CopilotAgentService.Infrastructure.Services;
using CopilotAgentService.Application.Services;
using CopilotAgentService.Application.Handlers;
using CopilotAgentService.Application.Mappings;
using CopilotAgentService.Application.Validators;
using CopilotAgentService.Domain.Repositories;
using CopilotAgentService.Domain.Services;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    c.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "CopilotAgentService.API.xml"));
});
